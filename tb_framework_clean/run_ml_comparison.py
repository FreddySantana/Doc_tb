"""
Script de Execução Completa: White Box vs Black Box
===================================================

Este script executa o pipeline completo de treinamento e comparação
de modelos White Box (Regressão Logística, Árvore de Decisão) vs
Black Box (XGBoost, LightGBM, CatBoost).
