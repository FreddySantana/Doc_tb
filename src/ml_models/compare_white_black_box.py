...
def main():
    """Exemplo de uso com dados reais de tuberculose."""
    # Carregar dados reais de TB
    from src.data.data_loader import load_tb_data
    from sklearn.model_selection import train_test_split
    
    logger.info("Carregando dados reais de tuberculose...")
    X, y = load_tb_data()
    
    logger.info(f"Dados carregados: {X.shape[0]} pacientes, {X.shape[1]} features")
